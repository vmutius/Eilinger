    ...
    @foreach ($siblings as $index => $sibling)
        <div class="row g-3">
            ...
            <div class="col-sm-12">
                ...
                <input wire:model.blur="siblings.{{ $index }}.place_of_residence" type="text" class="form-control"/>
                <span
            ...
            <div class="col-sm-2">
                ...
                <input wire:model.blur="siblings.{{ $index }}.graduation_year" type="number" class="form-control"/>
                <span class="text-danger">@error('siblings.'. $index .'.employer'){{ $message }}@enderror</span>
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-4">
                ...
                <input wire:model.blur="siblings.{{ $index }}.support_site" type="text" class="form-control"/>
